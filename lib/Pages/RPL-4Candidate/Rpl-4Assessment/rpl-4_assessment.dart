...
import 'package:Scaleindia/Pages/RPL-4Candidate/Rpl-4Assessment/theory_page.dart';
...
class Rpl4AssessmentPage extends StatefulWidget {
  final Candidate candidate;
  final CenterAssesor centerAssesor;
  Rpl4AssessmentPage({this.candidate, this.centerAssesor});
  @override
  _Rpl4AssessmentPageState createState() => _Rpl4AssessmentPageState();
}

class _Rpl4AssessmentPageState extends State<Rpl4AssessmentPage> {
  String url;
