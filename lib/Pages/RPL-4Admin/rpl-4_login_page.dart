import 'package:Scaleindia/Pages/RPL-4Admin/rpl-4_admin_viewmodel.dart';
...
class RPL4AdminLoginPage extends StatelessWidget {
  final emailController = TextEditingController();
  final passwordController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<RPL4AdminViewModel>.reactive(
      viewModelBuilder: () => RPL4AdminViewModel(),
