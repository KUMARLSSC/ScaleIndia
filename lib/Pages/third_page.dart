                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DataTable(columns:<DataColumn>[
                              DataColumn(
                                label: Text('Center :', style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 20.0,
                                ),),
                              ),
                              DataColumn(
                                label: Text('Chennai', style: TextStyle(
                    ...
                    rows: <DataRow>[
                      DataRow(
                        cells: <DataCell>[
                        DataCell(Text("Assesser Name :", style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20.0,
                                        ),)),
                         DataCell(Text("Snbham",style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20.0,
                                        ),
                       ...
                       DataRow(
                        cells: <DataCell>[
                        DataCell(Text("Request ID :", style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20.0,
                                        ),)),
                       ...
                       DataRow(
                        cells: <DataCell>[
                        DataCell(Text("Batch ID :", style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20.0,
                                        ),)),
                         DataCell(Text("SDMS9178",style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 20.0,
                                        ),
