...
class CompanyCreatWidget extends StatefulWidget {
  final ComapanySourcing comapanySourcing;
  CompanyCreatWidget({Key key, this.comapanySourcing}) : super(key: key);

  @override
  _CompanyCreatWidgetState createState() => _CompanyCreatWidgetState();
}

class _CompanyCreatWidgetState extends State<CompanyCreatWidget> {
  final List<String> gender = ['Male', 'Female', 'Transgender'];
  final List<String> jobJoble = [
    'Stiching operator Footwear(Non Leather)',
    'Stiching operator Footwear(Leather)',
    'Sticher (Goods and Garments)',
    'Cutter (Footwear)',
    'Cutter (Goods and Garments)',
    'Pre Assembly Operator(Non Leather)',
    'Pre Assembly Operator(Leather)',
    'Lasting Operator(Non Leather)',
    'Lasting Operator(Leather)',
    'Helper Upper Making',
    'Helper Finishing Footwear',
    'Helper Finishing Operator',
    'Others',
  ];
  ...
  Map<String, String> stateCity = {
    ...
    "Delhi": "Delhi", "New Delhi*": "Delhi", "Mapusa": "Goa", "Margao": "Goa",
    "Marmagao": "Goa", "Panaji*": "Goa",
    "Adalaj": "Gujarat",
    "Ahmedabad": "Gujarat",
    "Amreli": "Gujarat",
    "Anand": "Gujarat",
    ...
    "Drass Ladakh": "Ladakh",
    "Leh Ladakh": "Ladakh",
    "Kargil Ladakh": "Ladakh",
    "Suru Valley Ladakh": "Ladakh",
    "Zanskar Ladakh": "Ladakh",
    "Padum Ladakh": "Ladakh",
  ...
  final requestDepartmentController = TextEditingController();
  final durationController = TextEditingController();
  final functionController = TextEditingController();
  final jobRoleController = TextEditingController();
  final numberofpositionController = TextEditingController();
  final qualificationController = TextEditingController();
  final phoneNumberController = TextEditingController();
  final experienceController = TextEditingController();
  final specificDetailsController = TextEditingController();
  final workExperianceController = TextEditingController();
  final genderController = TextEditingController();
  final cityController = TextEditingController();
  final dateOfJoinController = TextEditingController();
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ExpansionList<String>(
                          items: function,
                          title: model.selectedFunction,
                          onItemSelected: model.setSelectedFunction),
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ExpansionList<String>(
                          items: jobJoble,
                          title: model.selectJobRole,
                          onItemSelected: model.setSelectedJobRole),
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: InputField(
                        placeholder: "0",
                        controller: numberofpositionController,
              ...
              BusyButton(
                ...
                onPressed: () {
                  model.addPostCs(
                      ...
                      requestDepartment: requestDepartmentController.text,
                      gender: genderController.text,
                      duration: durationController.text,
                      function: functionController.text,
                      jobRole: jobRoleController.text,
                      numberofposition: numberofpositionController.text,
                      qualification: qualificationController.text,
                      experience: experienceController.text,
                      state: selectedState,
                      city: selectedcity,
                      dateOfJoin: dateOfJoinController.text,
                      specificDetails: specificDetailsController.text,
