...
class ECASCreatWidget extends StatefulWidget {
  final EmployeeCandidateSourcing employeeCandidateSourcing;
  ECASCreatWidget({Key key, this.employeeCandidateSourcing}) : super(key: key);

  @override
  _ECASCreatWidgetState createState() => _ECASCreatWidgetState();
}

class _ECASCreatWidgetState extends State<ECASCreatWidget> {
