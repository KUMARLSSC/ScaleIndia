...
List<Company> companyList = [
  Company(
    ...
    city: "California, CA",
    sallary: "\Rs50K - \Rs90K",
    image: "assets/img/nike-Logo.png",
    tag: [
      "Full Time",
      "Remote",
      "Anywhere",
  ...
  Company(
    ...
    sallary: "\Rs30K - \Rs50K",
    image: "assets/img/uber-logo-redesign_1x.png",
    tag: [
      "Full Time",
      "Remote",
      "Anywhere",
  ...
  Company(
    ...
    city: "Washington, DC",
    sallary: "\Rs45K - \Rs78K",
    image: "assets/img/soundcloud-icon.png",
    tag: [
      "Full Time",
      "Remote",
      "Anywhere",
  ...
  Company(
    ...
    sallary: "\Rs45K - \Rs78K",
    image:
        "assets/img/youtube-black-icon-youtube-icon-youtube-logo-youtube-png-and-black-youtube-logo-640_640.png",
    tag: [
      "Full Time",
      "Remote",
      "Anywhere",
